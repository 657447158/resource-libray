...
(function( $ ) {
	...
	function createBox( $fileInput, file, webUploader ) {
		...
		if($fileInput.selector=="#erw_img" &&  $parentFileBox.length > 0){
			$("#erwm_del").val($parentFileBox.children(".fileBoxUl").find("img").attr("src"));
			$parentFileBox.children(".fileBoxUl").children("li").remove();
		}
		if($fileInput.selector=="#cover_img" &&  $parentFileBox.length > 0){
			$("#coverImg_del").val($parentFileBox.children(".fileBoxUl").find("img").attr("src"));
			$parentFileBox.children(".fileBoxUl").children("li").remove();
		}
		if($fileInput.selector=="#download_file" &&  $parentFileBox.length > 0){
			$("#download_del").val($parentFileBox.children(".fileBoxUl").find("img").attr("src"));
			$parentFileBox.children(".fileBoxUl").children("li").remove();
		}
		...
		var li = '<li id="fileBox_'+file_id+'" class="diyUploadHover"> \
					...
					<p class="diyCut"><a class="cut_left">&nbsp;</a><a class="cut_right">&nbsp;</a><a class="cut_close">&nbsp;</a></p>\
					<div class="diyBar"> \
