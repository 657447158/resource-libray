...
var api = require('../../api/admin/menu');
...
// 获取菜单操作权限列表
router.get('/getMenuOperateList', function (req, res, next) {
    api.getMenuOperateList(req, res, next)
})

// 获取权限列表
router.get('/getOperateList', function (req, res, next) {
    api.getOperateList(req, res, next)
})
